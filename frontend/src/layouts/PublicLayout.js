          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            <div className="col-span-2">
              ...
              <p className="mt-4 text-white/50 text-sm leading-relaxed max-w-sm">
                Kuzey Kıbrıs'ın en güvenilir sosyal eşlik platformu. Yemek eşliği, davet arkadaşlığı ve özel anlardaki deneyimler için profesyonel hizmet.
              </p>
              
              {/* Social Media */}
              <div className="flex gap-4 mt-6">
                <a href="#" className="w-10 h-10 rounded-full bg-white/5 hover:bg-[#E91E63]/20 flex items-center justify-center text-white/50 hover:text-[#E91E63] transition-colors">
            ...
            <div>
              ...
              <div className="space-y-2">
                <Link to={`/${lang}/girne/partnerler`} className="block text-white/50 hover:text-[#E91E63] text-sm transition-colors">Girne</Link>
                <Link to={`/${lang}/lefkosa/partnerler`} className="block text-white/50 hover:text-[#E91E63] text-sm transition-colors">Lefkoşa</Link>
                <Link to={`/${lang}/gazimagusa/partnerler`} className="block text-white/50 hover:text-[#E91E63] text-sm transition-colors">Gazimağusa</Link>
                <Link to={`/${lang}/guzelyurt/partnerler`} className="block text-white/50 hover:text-[#E91E63] text-sm transition-colors">Güzelyurt</Link>
                <Link to={`/${lang}/iskele/partnerler`} className="block text-white/50 hover:text-[#E91E63] text-sm transition-colors">İskele</Link>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <Link to={`/${lang}/limasol/partnerler`} className="block text-white/50 hover:text-[#E91E63] text-sm transition-colors">Limasol</Link>
                <Link to={`/${lang}/larnaka/partnerler`} className="block text-white/50 hover:text-[#E91E63] text-sm transition-colors">Larnaka</Link>
                <Link to={`/${lang}/baf/partnerler`} className="block text-white/50 hover:text-[#E91E63] text-sm transition-colors">Baf (Paphos)</Link>
                <Link to={`/${lang}/ayia-napa/partnerler`} className="block text-white/50 hover:text-[#E91E63] text-sm transition-colors">Ayia Napa</Link>
                <Link to={`/${lang}/protaras/partnerler`} className="block text-white/50 hover:text-[#E91E63] text-sm transition-colors">Protaras</Link>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <Link to={`/${lang}/hakkimizda`} className="block text-white/50 hover:text-[#E91E63] text-sm transition-colors">{t('about')}</Link>
                <Link to={`/${lang}/sss`} className="block text-white/50 hover:text-[#E91E63] text-sm transition-colors">{t('faq')}</Link>
                <Link to={`/${lang}/iletisim`} className="block text-white/50 hover:text-[#E91E63] text-sm transition-colors">{t('contact')}</Link>
                <Link to={`/${lang}/kayit`} className="block text-white/50 hover:text-[#E91E63] text-sm transition-colors">Partner Ol</Link>
              </div>
              
              <h4 className="text-white font-semibold mb-4 mt-6 text-sm uppercase tracking-wider">Yasal</h4>
              <div className="space-y-2">
                <Link to={`/${lang}/gizlilik`} className="block text-white/50 hover:text-[#E91E63] text-sm transition-colors">{t('privacy')}</Link>
                <Link to={`/${lang}/kullanim-sartlari`} className="block text-white/50 hover:text-[#E91E63] text-sm transition-colors">{t('terms')}</Link>
              </div>
            </div>
          </div>
        </div>
