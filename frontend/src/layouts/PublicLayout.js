          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            <div className="col-span-2">
              ...
              <div className="flex gap-4 mt-6">
                <a href="#" className="w-10 h-10 rounded-full bg-white/5 hover:bg-[#D4AF37]/20 flex items-center justify-center text-white/50 hover:text-[#D4AF37] transition-colors">
